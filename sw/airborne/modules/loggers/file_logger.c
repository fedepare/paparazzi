...
static void file_logger_write_header(FILE *file) {
  ...
  fprintf(file, "div,divdot,div_gt,divdot_gt,thrust,upboard_thrust,thrust_lp,acc_sp,acc_lp,spike_count,record,");
#ifdef COMMAND_THRUST
...
static void file_logger_write_row(FILE *file) {
  ...
  fprintf(file, "%f,%f,%f,%f,%f,%f,%f,%f,%f,%d,%d,", divergence, divergence_dot, div_gt, divdot_gt, thrust, upboard_thrust, thrust_lp, acceleration_sp, acc_lp, spike_count, record);
#ifdef COMMAND_THRUST
