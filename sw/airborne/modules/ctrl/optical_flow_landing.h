...
extern float thrust_history[MAX_COV_WINDOW_SIZE];
extern float divergence_history[MAX_COV_WINDOW_SIZE];
extern float past_divergence_history[MAX_COV_WINDOW_SIZE];
extern float dt_history[MAX_COV_WINDOW_SIZE];
extern unsigned long ind_hist;
